/**
 * Gauss-Jordan elimination code adapted from
...
Mat.prototype.gauss = function() {
  ...
  for (let i = 0; i < nullLines.length; i++) {
    if (!this.mirror.hasNullLine(nullLines[i])) {
      return null;  // This case should have been handled before
                    // the solve method is called, but just in case...
 ...
 * @return x
 */
const linearEqnSolve = function(A, b) {
